...
describe('Service Tests', () => {
  describe('DiscountType Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new DiscountType(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a DiscountType', async () => {
      ...
      it('should update a DiscountType', async () => {
        const returnedFromService = Object.assign(
          {
            title: 'BBBBBB'
          },
      ...
      it('should return a list of DiscountType', async () => {
        const returnedFromService = Object.assign(
          {
            title: 'BBBBBB'
          },
      ...
      it('should delete a DiscountType', async () => {
